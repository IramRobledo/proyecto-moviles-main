...
import 'package:proyecto_moviles/src/pages/market/products/create/market_products_create_controller.dart';
import 'package:proyecto_moviles/src/utils/my_colors.dart';

class MarketProductsCreatePage extends StatefulWidget {
  const MarketProductsCreatePage({Key key}) : super(key: key);

  @override
  _MarketProductsCreatePageState createState() =>
      _MarketProductsCreatePageState();
}

class _MarketProductsCreatePageState
    extends State<MarketProductsCreatePage> {
  MarketProductsCreateController _con =
      new MarketProductsCreateController();

...
import 'package:proyecto_moviles/src/pages/market/orders/detail/market_orders_detail_controller.dart';
import 'package:proyecto_moviles/src/utils/my_colors.dart';
import 'package:proyecto_moviles/src/utils/relative_time_util.dart';
import 'package:proyecto_moviles/src/widgets/no_data_widget.dart';

class MarketOrdersDetailPage extends StatefulWidget {
  Order order;

  MarketOrdersDetailPage({Key key, @required this.order}) : super(key: key);

  @override
  _MarketOrdersDetailPageState createState() =>
      _MarketOrdersDetailPageState();
}

class _MarketOrdersDetailPageState
    extends State<MarketOrdersDetailPage> {
  MarketOrdersDetailController _con =
      new MarketOrdersDetailController();

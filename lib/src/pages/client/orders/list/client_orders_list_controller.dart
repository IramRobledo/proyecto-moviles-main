...
import 'package:proyecto_moviles/src/pages/client/orders/detail/client_orders_detail_page.dart';
import 'package:proyecto_moviles/src/pages/delivery/orders/detail/delivery_orders_detail_page.dart';
import 'package:proyecto_moviles/src/pages/market/orders/detail/market_orders_detail_page.dart';
...
class ClientOrdersListController {
  ...
  void goToCategoryCreate() {
    Navigator.pushNamed(context, 'market/categories/create');
  }

  void goToProductCreate() {
    Navigator.pushNamed(context, 'market/products/create');
  }
